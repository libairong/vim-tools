...
func SetComment()
    ...
    call append(l:currentLine,   "*   Copyright (C) ".strftime("%Y")." Sangfor Ltd. All rights reserved.")
    call append(l:currentLine+1, "*")
    call append(l:currentLine+2, "*   文件名称：".expand("%:t"))
    call append(l:currentLine+3, "*   创 建 者：bairong.li")
    call append(l:currentLine+4, "*   创建日期：".strftime("%Y年%m月%d日"))
    call append(l:currentLine+5, "*   描    述：")
...
func SetComment_sh()
    ...
    call setline(7, "#   创 建 者：bairong.li")
